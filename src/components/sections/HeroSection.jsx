...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-white to-secondary/10">
      <motion.div
      ...
      >
        ...
        >
          Профессиональная видеосъемка, эффективное обучение английскому 
          и уникальные товары — все в одном месте
        </motion.p>
